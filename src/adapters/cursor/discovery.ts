...
export const CURSOR_STATIC_MODELS: readonly CursorModelInfo[] = normalizeCursorModels([
  ...
  { id: "gpt-5.5-extra", contextWindow: CONTEXT_272K, supportsReasoningEffort: true },
  { id: "gpt-5.6-sol", contextWindow: CONTEXT_272K, supportsReasoningEffort: true },
  { id: "gpt-5.6-terra", contextWindow: CONTEXT_272K, supportsReasoningEffort: true },
  { id: "gpt-5.6-luna", contextWindow: CONTEXT_272K, supportsReasoningEffort: true },
