...
export const zh: Record<TKey, string> = {
  ...
  "usage.mcp.title": "Linux MCP 实时载荷节省",
  "usage.mcp.subtitle": "{calls} 次已测调用 · 根据实测字符估算令牌",
  "usage.mcp.unbounded": "估算的无限制令牌",
  "usage.mcp.returned": "估算的返回令牌",
  "usage.mcp.avoided": "估算的避免令牌",
  "usage.mcp.estimatedChars": "{count} 个估算字符",
  "usage.mcp.measuredChars": "{count} 个实测字符",
  "usage.mcp.calls": "已测调用",
  "usage.mcp.truncated": "受限调用",
  "usage.mcp.less": "约减少 {percent}%",
