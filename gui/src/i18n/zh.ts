...
export const zh: Record<TKey, string> = {
  ...
  "usage.reset.label": "重置统计",
  "usage.reset.resetting": "正在重置…",
  "usage.reset.success": "统计已重置。",
  "usage.reset.partial": "本地统计已重置，但 Linux MCP 未能重置。",
  "usage.reset.failed": "无法重置统计。",
  "usage.range.all": "全部",
  ...
  "usage.totalSavings.title": "预计总节省",
  "usage.totalSavings.note": "当前范围内提供方上报的 Token，加上已测量的 Ultimate Context 节省量。",
  "usage.totalSavings.rate": "预计节省率",
  "usage.totalSavings.before": "预计处理前",
  "usage.totalSavings.after": "处理后 Token",
  "usage.totalSavings.saved": "预计节省",
  "usage.mcp.title": "Linux MCP",
  "usage.mcp.active": "运行中",
  "usage.mcp.inactive": "不可用",
  "usage.mcp.estimatedSavings": "估算节省率",
  "usage.mcp.callsSinceReset": "重置后调用",
  "usage.mcp.estimatedBeforeTokens": "MCP 前估算令牌",
  "usage.mcp.estimatedReturnedTokens": "估算返回令牌",
  "usage.mcp.estimatedSavedTokens": "估算节省令牌",
  "usage.context.title": "Ultimate Context",
  "usage.context.note": "自上次重置以来的实时估算，与提供商上报的 Token 总数分开统计。",
  "usage.context.active": "运行中",
  "usage.context.inactive": "不可用",
  "usage.context.estimatedSavings": "估算节省率",
  "usage.context.estimatedBeforeTokens": "处理前估算",
  "usage.context.estimatedReturnedTokens": "返回估算",
  "usage.context.estimatedSavedTokens": "节省估算",
  "usage.context.processed": "工具结果",
  "usage.context.reduced": "已精简",
  "usage.context.retrievals": "检索次数",
  "usage.context.cacheHits": "缓存命中",
  "usage.context.avgLatency": "平均额外耗时",
  "usage.context.sourceIncomplete": "源端受限",
  "usage.context.errors": "错误",
  "usage.context.layers": "分层明细",
  "usage.context.layer": "层",
  "usage.context.layerLinuxMcp": "Linux MCP",
  "usage.context.layerAllTools": "其他工具",
