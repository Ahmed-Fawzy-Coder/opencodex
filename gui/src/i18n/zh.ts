...
export const zh: Record<TKey, string> = {
  ...
  "usage.mcp.title": "Linux MCP 实时遥测",
  "usage.mcp.subtitle": "{calls} 次已测调用 · 实时数据不声明节省令牌",
  "usage.mcp.returned": "估算的返回令牌",
  "usage.mcp.measuredChars": "返回字符",
  "usage.mcp.discarded": "内部丢弃输出（字符）",
  "usage.mcp.calls": "已测调用",
  "usage.mcp.truncated": "受限调用",
  "usage.mcp.benchmarkTitle": "Linux MCP 对照基准",
  "usage.mcp.benchmarkSubtitle": "{rounds} 轮配对测试 · 历史输入令牌",
  "usage.mcp.benchmarkWithout": "不使用 MCP",
  "usage.mcp.benchmarkWith": "使用 MCP",
  "usage.mcp.benchmarkDifference": "差值",
  "usage.mcp.benchmarkLess": "降低 {percent}%",
