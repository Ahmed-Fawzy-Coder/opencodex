...
export const de = {
  ...
  "usage.mcp.title": "Live-Nutzlast-Einsparung durch Linux MCP",
  "usage.mcp.subtitle": "{calls} gemessene Aufrufe · Token-Schätzungen aus gemessenen Zeichen",
  "usage.mcp.unbounded": "Geschätzte unbegrenzte Tokens",
  "usage.mcp.returned": "Geschätzte zurückgegebene Tokens",
  "usage.mcp.avoided": "Geschätzte vermiedene Tokens",
  "usage.mcp.estimatedChars": "{count} geschätzte Zeichen",
  "usage.mcp.measuredChars": "{count} gemessene Zeichen",
  "usage.mcp.calls": "Gemessene Aufrufe",
  "usage.mcp.truncated": "Begrenzte Aufrufe",
  "usage.mcp.less": "~{percent}% kleiner",
