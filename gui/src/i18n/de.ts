...
export const de = {
  ...
  "usage.mcp.title": "Linux MCP Live-Telemetrie",
  "usage.mcp.subtitle": "{calls} gemessene Aufrufe · Live-Daten behaupten keine Token-Einsparung",
  "usage.mcp.returned": "Geschätzte zurückgegebene Tokens",
  "usage.mcp.measuredChars": "Zurückgegebene Zeichen",
  "usage.mcp.discarded": "Intern verworfene Ausgabe (Zeichen)",
  "usage.mcp.calls": "Gemessene Aufrufe",
  "usage.mcp.truncated": "Begrenzte Aufrufe",
  "usage.mcp.benchmarkTitle": "Kontrollierter Linux-MCP-Benchmark",
  "usage.mcp.benchmarkSubtitle": "{rounds} gepaarte Runden · historische Eingabe-Tokens",
  "usage.mcp.benchmarkWithout": "Ohne MCP",
  "usage.mcp.benchmarkWith": "Mit MCP",
  "usage.mcp.benchmarkDifference": "Differenz",
  "usage.mcp.benchmarkLess": "{percent}% niedriger",
