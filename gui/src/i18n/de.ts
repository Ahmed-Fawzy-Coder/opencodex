...
export const de = {
  ...
  "usage.reset.label": "Statistiken zurücksetzen",
  "usage.reset.resetting": "Wird zurückgesetzt…",
  "usage.reset.success": "Statistiken wurden zurückgesetzt.",
  "usage.reset.partial": "Lokale Statistiken wurden zurückgesetzt, Linux MCP jedoch nicht.",
  "usage.reset.failed": "Statistiken konnten nicht zurückgesetzt werden.",
  ...
  "usage.totalSavings.title": "Geschätzte Gesamteinsparung",
  "usage.totalSavings.note": "Vom Anbieter gemeldete Tokens plus gemessene Ultimate-Context-Einsparungen für diesen Zeitraum.",
  "usage.totalSavings.rate": "Geschätzte Einsparung",
  "usage.totalSavings.before": "Geschätzt vorher",
  "usage.totalSavings.after": "Tokens danach",
  "usage.totalSavings.saved": "Geschätzt eingespart",
  "usage.mcp.title": "Linux MCP",
  "usage.mcp.active": "Aktiv",
  "usage.mcp.inactive": "Nicht verfügbar",
  "usage.mcp.estimatedSavings": "Geschätzte Einsparung",
  "usage.mcp.callsSinceReset": "Aufrufe seit Zurücksetzung",
  "usage.mcp.estimatedBeforeTokens": "Geschätzte Tokens vor MCP",
  "usage.mcp.estimatedReturnedTokens": "Geschätzte zurückgegebene Tokens",
  "usage.mcp.estimatedSavedTokens": "Geschätzte eingesparte Tokens",
  "usage.context.title": "Ultimate Context",
  "usage.context.note": "Live-Schätzungen seit dem letzten Zurücksetzen. Getrennt von den gemeldeten Provider-Tokens.",
  "usage.context.active": "Aktiv",
  "usage.context.inactive": "Nicht verfügbar",
  "usage.context.estimatedSavings": "Geschätzte Einsparung",
  "usage.context.estimatedBeforeTokens": "Geschätzt vorher",
  "usage.context.estimatedReturnedTokens": "Geschätzt zurückgegeben",
  "usage.context.estimatedSavedTokens": "Geschätzt eingespart",
  "usage.context.processed": "Werkzeugergebnisse",
  "usage.context.reduced": "Reduziert",
  "usage.context.retrievals": "Abrufe",
  "usage.context.cacheHits": "Cache-Treffer",
  "usage.context.avgLatency": "Ø Zusatzzeit",
  "usage.context.sourceIncomplete": "Quellseitig begrenzt",
  "usage.context.errors": "Fehler",
  "usage.context.layers": "Ebenenaufschlüsselung",
  "usage.context.layer": "Ebene",
  "usage.context.layerLinuxMcp": "Linux MCP",
  "usage.context.layerAllTools": "Andere Werkzeuge",
