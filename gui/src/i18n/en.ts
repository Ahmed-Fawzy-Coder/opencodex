...
export const en = {
  ...
  "usage.mcp.title": "Linux MCP live telemetry",
  "usage.mcp.subtitle": "{calls} measured calls · live data makes no token-savings claim",
  "usage.mcp.returned": "Estimated returned tokens",
  "usage.mcp.measuredChars": "Returned characters",
  "usage.mcp.discarded": "Internal output discarded (characters)",
  "usage.mcp.calls": "Measured calls",
  "usage.mcp.truncated": "Bounded calls",
  "usage.mcp.benchmarkTitle": "Linux MCP controlled benchmark",
  "usage.mcp.benchmarkSubtitle": "{rounds} paired rounds · historical input tokens",
  "usage.mcp.benchmarkWithout": "Without MCP",
  "usage.mcp.benchmarkWith": "With MCP",
  "usage.mcp.benchmarkDifference": "Difference",
  "usage.mcp.benchmarkLess": "{percent}% lower",
