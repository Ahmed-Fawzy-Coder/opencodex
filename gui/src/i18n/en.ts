...
export const en = {
  ...
  "usage.reset.label": "Reset statistics",
  "usage.reset.resetting": "Resetting…",
  "usage.reset.success": "Statistics reset successfully.",
  "usage.reset.partial": "Local statistics were reset, but Linux MCP could not be reset.",
  "usage.reset.failed": "Statistics could not be reset.",
  "usage.range.all": "All",
  "usage.range.30d": "30d",
  "usage.range.7d": "7d",
  ...
  "usage.totalSavings.title": "Estimated total savings",
  "usage.totalSavings.note": "Provider-reported tokens plus measured Ultimate Context savings for this range.",
  "usage.totalSavings.rate": "Estimated savings",
  "usage.totalSavings.before": "Estimated before",
  "usage.totalSavings.after": "Tokens after",
  "usage.totalSavings.saved": "Estimated saved",
  "usage.mcp.title": "Linux MCP",
  "usage.mcp.active": "Active",
  "usage.mcp.inactive": "Unavailable",
  "usage.mcp.estimatedSavings": "Estimated savings",
  "usage.mcp.callsSinceReset": "Calls since reset",
  "usage.mcp.estimatedBeforeTokens": "Estimated tokens before MCP",
  "usage.mcp.estimatedReturnedTokens": "Estimated returned tokens",
  "usage.mcp.estimatedSavedTokens": "Estimated tokens saved",
  "usage.context.title": "Ultimate Context",
  "usage.context.note": "Live estimates since the last reset. Kept separate from provider-reported token totals.",
  "usage.context.active": "Active",
  "usage.context.inactive": "Unavailable",
  "usage.context.estimatedSavings": "Estimated savings",
  "usage.context.estimatedBeforeTokens": "Estimated before",
  "usage.context.estimatedReturnedTokens": "Estimated returned",
  "usage.context.estimatedSavedTokens": "Estimated saved",
  "usage.context.processed": "Tool results",
  "usage.context.reduced": "Reduced",
  "usage.context.retrievals": "Retrievals",
  "usage.context.cacheHits": "Cache hits",
  "usage.context.avgLatency": "Avg overhead",
  "usage.context.sourceIncomplete": "Source-bounded",
  "usage.context.errors": "Errors",
  "usage.context.layers": "Layer breakdown",
  "usage.context.layer": "Layer",
  "usage.context.layerLinuxMcp": "Linux MCP",
  "usage.context.layerAllTools": "Other tools",
