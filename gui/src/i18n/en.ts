...
export const en = {
  ...
  "usage.mcp.title": "Linux MCP live payload savings",
  "usage.mcp.subtitle": "{calls} measured calls · token estimates derived from measured characters",
  "usage.mcp.unbounded": "Estimated unbounded tokens",
  "usage.mcp.returned": "Estimated returned tokens",
  "usage.mcp.avoided": "Estimated avoided tokens",
  "usage.mcp.estimatedChars": "{count} estimated characters",
  "usage.mcp.measuredChars": "{count} measured characters",
  "usage.mcp.calls": "Measured calls",
  "usage.mcp.truncated": "Bounded calls",
  "usage.mcp.less": "~{percent}% smaller",
