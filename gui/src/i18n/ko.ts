...
export const ko: Record<TKey, string> = {
  ...
  "usage.mcp.title": "Linux MCP 실시간 텔레메트리",
  "usage.mcp.subtitle": "측정된 호출 {calls}회 · 실시간 데이터는 토큰 절감을 주장하지 않음",
  "usage.mcp.returned": "예상 반환 토큰",
  "usage.mcp.measuredChars": "반환된 문자",
  "usage.mcp.discarded": "내부에서 폐기된 출력(문자)",
  "usage.mcp.calls": "측정된 호출",
  "usage.mcp.truncated": "제한된 호출",
  "usage.mcp.benchmarkTitle": "Linux MCP 통제 벤치마크",
  "usage.mcp.benchmarkSubtitle": "대응 비교 {rounds}회 · 과거 입력 토큰",
  "usage.mcp.benchmarkWithout": "MCP 없음",
  "usage.mcp.benchmarkWith": "MCP 사용",
  "usage.mcp.benchmarkDifference": "차이",
  "usage.mcp.benchmarkLess": "{percent}% 감소",
