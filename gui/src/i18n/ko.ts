...
export const ko: Record<TKey, string> = {
  ...
  "usage.mcp.title": "Linux MCP 실시간 페이로드 절감",
  "usage.mcp.subtitle": "측정된 호출 {calls}회 · 측정 문자에서 계산한 토큰 추정치",
  "usage.mcp.unbounded": "예상 무제한 토큰",
  "usage.mcp.returned": "예상 반환 토큰",
  "usage.mcp.avoided": "예상 절감 토큰",
  "usage.mcp.estimatedChars": "예상 문자 {count}개",
  "usage.mcp.measuredChars": "측정 문자 {count}개",
  "usage.mcp.calls": "측정된 호출",
  "usage.mcp.truncated": "제한된 호출",
  "usage.mcp.less": "약 {percent}% 감소",
