...
export const ko: Record<TKey, string> = {
  ...
  "usage.reset.label": "통계 초기화",
  "usage.reset.resetting": "초기화 중…",
  "usage.reset.success": "통계를 초기화했습니다.",
  "usage.reset.partial": "로컬 통계는 초기화했지만 Linux MCP는 초기화하지 못했습니다.",
  "usage.reset.failed": "통계를 초기화하지 못했습니다.",
  "usage.range.all": "전체",
  "usage.range.30d": "30일",
  "usage.range.7d": "7일",
  ...
  "usage.totalSavings.title": "예상 총 절감",
  "usage.totalSavings.note": "이 기간의 프로바이더 보고 토큰과 측정된 Ultimate Context 절감량을 합산합니다.",
  "usage.totalSavings.rate": "예상 절감률",
  "usage.totalSavings.before": "처리 전 예상",
  "usage.totalSavings.after": "처리 후 토큰",
  "usage.totalSavings.saved": "예상 절감",
  "usage.mcp.title": "Linux MCP",
  "usage.mcp.active": "활성",
  "usage.mcp.inactive": "사용 불가",
  "usage.mcp.estimatedSavings": "예상 절감률",
  "usage.mcp.callsSinceReset": "초기화 후 호출",
  "usage.mcp.estimatedBeforeTokens": "MCP 사용 전 예상 토큰",
  "usage.mcp.estimatedReturnedTokens": "예상 반환 토큰",
  "usage.mcp.estimatedSavedTokens": "예상 절감 토큰",
  "usage.context.title": "Ultimate Context",
  "usage.context.note": "마지막 초기화 이후의 실시간 추정치입니다. 제공자 보고 토큰 합계와 별도로 집계됩니다.",
  "usage.context.active": "활성",
  "usage.context.inactive": "사용 불가",
  "usage.context.estimatedSavings": "예상 절감률",
  "usage.context.estimatedBeforeTokens": "처리 전 예상",
  "usage.context.estimatedReturnedTokens": "반환 예상",
  "usage.context.estimatedSavedTokens": "절감 예상",
  "usage.context.processed": "도구 결과",
  "usage.context.reduced": "축소됨",
  "usage.context.retrievals": "검색",
  "usage.context.cacheHits": "캐시 적중",
  "usage.context.avgLatency": "평균 추가 지연",
  "usage.context.sourceIncomplete": "원본 제한",
  "usage.context.errors": "오류",
  "usage.context.layers": "레이어 상세",
  "usage.context.layer": "레이어",
  "usage.context.layerLinuxMcp": "Linux MCP",
  "usage.context.layerAllTools": "기타 도구",
